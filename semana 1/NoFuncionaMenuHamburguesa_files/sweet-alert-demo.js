...
$('#sa-solicitud-ok').on('click', function () {
    Swal.fire({
        type: 'sucess',
...
$('#sa-pedidogenerico-ok').on('click', function () {
  Swal.fire({
      type: 'sucess',
      title: 'Pedido genérico generado con éxito',
      confirmButtonClass: 'btn btn-confirm mt-2'
  })
});

$('#sa-pedidocustom-ok').on('click', function () {
  Swal.fire({
      type: 'sucess',
      title: 'Pedido personalizado generado con éxito',
      confirmButtonClass: 'btn btn-confirm mt-2'
  })
});

$('#sa-orden-ok').on('click', function () {
  Swal.fire({
      type: 'sucess',
      title: mensajeAlerta,
      confirmButtonClass: 'btn btn-confirm mt-2'
