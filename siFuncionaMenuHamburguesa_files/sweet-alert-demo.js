...
$('#sa-inventario').on('click', function () {
    Swal.fire({
        type: 'error',
        title: 'No hay disponibilidad de producto',
        confirmButtonClass: 'btn btn-confirm mt-2'
    })
});

$('#sa-eliminar1').click(function () {
    Swal.fire({
        title: 'Está seguro?',
        ...
        if (result.value) {
            Swal.fire({
              title: 'Eliminado!',
              text: 'El producto se ha eliminado de su pedido.',
              type: 'success',
            ...
            Swal.fire({
              title: 'Cancelado',
              text: 'Ha cancelado la eliminación del producto',
              type: 'error'
            })
          }
    });
...
$('#sa-fecha').on('click', function () {
    Swal.fire({
        type: 'error',
        title: 'Fecha no válida. Seleccione otra fecha',
        confirmButtonClass: 'btn btn-confirm mt-2'
    })
});
...
$('#sa-basic').on('click', function () {
    Swal.fire({
        title: 'Revise los datos agregados',
        confirmButtonClass: 'btn btn-confirm mt-2'
    })
});
